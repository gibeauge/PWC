...
<xsl:include href="ipc_gentext.xsl"/>
<xsl:include href="ipc_numbering.xsl"/>
...
<xsl:template match="inter" priority="0">
  <xsl:variable name="l-prc" select="@prc"/>
  <div>
     <xsl:attribute name="class">
        <xsl:text>x-inter-1-0</xsl:text>
        <xsl:choose>
          <xsl:when test="$l-prc='1'"> x-inter-1-1</xsl:when>
          <xsl:when test="$l-prc='2'"> x-inter-1-2</xsl:when>
          <xsl:when test="$l-prc='3'"> x-inter-1-3</xsl:when>
          <xsl:when test="$l-prc='6'"> x-inter-1-4</xsl:when>
          <xsl:when test="$l-prc='7'"> x-inter-1-5</xsl:when>
          <xsl:when test="$l-prc='N'"> x-inter-1-6</xsl:when>
          <xsl:when test="$l-prc='S'"> x-inter-1-7</xsl:when>
        </xsl:choose>
     </xsl:attribute>
     <xsl:call-template name="t-base-div-basic"/>
  </div>
