...
<xsl:template match="pwcspblist/_ufe:glossary-title" priority="1" mode="toc-mode-Table_of_Contents"><!--This title doesn't go into this ToC--></xsl:template>
...
<xsl:template match="pbfmatr/_ufe:nut-option-title" priority="2" mode="toc-mode-Table_of_Contents"><!--This title doesn't go into this ToC--></xsl:template>

<xsl:template match="pwcspblist/_ufe:nut-option-title" priority="1" mode="toc-mode-Table_of_Contents"><!--This title doesn't go into this ToC--></xsl:template>
...
<xsl:template match="pgblk/_ufe:supplier-list-title" priority="3" mode="toc-mode-Table_of_Contents"><!--This title doesn't go into this ToC--></xsl:template>

<xsl:template match="pbfmatr/_ufe:supplier-list-title" priority="2" mode="toc-mode-Table_of_Contents"><!--This title doesn't go into this ToC--></xsl:template>

<xsl:template match="pwcspblist/_ufe:supplier-list-title" priority="1" mode="toc-mode-Table_of_Contents"><!--This title doesn't go into this ToC--></xsl:template>
...
<xsl:template match="book[contains(@doctype, 'ipc')]/frontmatter//figure/title" priority="68" mode="toc-mode-Table_of_Contents"><!--This title doesn't go into this ToC--></xsl:template>
...
<xsl:template match="book[contains(@doctype, 'epc')]//figure/title" priority="54" mode="toc-mode-Table_of_Contents">
...
<xsl:template match="book[contains(@doctype, 'epc')]//graphic/title" priority="53" mode="toc-mode-Table_of_Contents">
      <_sfe:TocEntry1_Table_of_Contents>
         <xsl:attribute name="tocentry-indent-class"> x-Table-of-Contents-toc-entry-indent-1</xsl:attribute>
         <xsl:call-template name="maybe-set-id">
            <xsl:with-param name="attrname" select="'tocentry_id'"/>
...
<xsl:template match="book[contains(@doctype, 'ipc')]//figure/title" priority="52" mode="toc-mode-Table_of_Contents"><!--This title doesn't go into this ToC--></xsl:template>
