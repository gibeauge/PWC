...
<xsl:template match="nowrap" priority="0">
  <span style="white-space:nowrap" class=" x-nowrap-1-0">
    <xsl:call-template name="t-base-div-basic"/>
  </span>
</xsl:template>
...
<xsl:template match="numlist/part-group" priority="2">
  <table border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; " class=" x-part-group-2-0 x--zero-left-margins">
    <xsl:call-template name="t-base-step-table">
      <xsl:with-param name="col1-width" select="'1.5em'"/>
      <xsl:with-param name="col2-width" select="'12pt'"/>
      <xsl:with-param name="col3-width" select="''"/>
...
<xsl:template match="enumlist//enumlist//enumlist//enumlist/unlitem" priority="12">
  <table border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; " class=" x-unlitem-1-0 x--zero-left-margins">
    <xsl:call-template name="t-base-step-table">
      <xsl:with-param name="col1-width" select="'1.5em'"/>
      <xsl:with-param name="col2-width" select="'12pt'"/>
      <xsl:with-param name="col3-width" select="''"/>
...
<xsl:template match="enumlist//enumlist//enumlist/unlitem" priority="11">
  <table border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; " class=" x-unlitem-2-0 x--zero-left-margins">
    <xsl:call-template name="t-base-step-table">
      <xsl:with-param name="col1-width" select="'2em'"/>
      <xsl:with-param name="col2-width" select="'12pt'"/>
      <xsl:with-param name="col3-width" select="''"/>
...
<xsl:template match="list//list//list/unlitem" priority="10">
  <table border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; " class=" x-unlitem-3-0 x--zero-left-margins">
    <xsl:call-template name="t-base-step-table">
      <xsl:with-param name="col1-width" select="'0em'"/>
      <xsl:with-param name="col2-width" select="'15pt'"/>
      <xsl:with-param name="col3-width" select="''"/>
...
<xsl:template match="bullist//bullist//bullist/unlitem" priority="9">
  <table border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; " class=" x-unlitem-4-0 x--zero-left-margins">
    <xsl:call-template name="t-base-step-table">
      <xsl:with-param name="col1-width" select="'0em'"/>
      <xsl:with-param name="col2-width" select="'15pt'"/>
      <xsl:with-param name="col3-width" select="''"/>
...
<xsl:template match="enumlist//enumlist/unlitem" priority="8">
  <table border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; " class=" x-unlitem-5-0 x--zero-left-margins">
    <xsl:call-template name="t-base-step-table">
      <xsl:with-param name="col1-width" select="'1em'"/>
      <xsl:with-param name="col2-width" select="'12pt'"/>
      <xsl:with-param name="col3-width" select="''"/>
...
<xsl:template match="list//list/unlitem" priority="7">
  <table border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; " class=" x-unlitem-6-0 x--zero-left-margins">
    <xsl:call-template name="t-base-step-table">
      <xsl:with-param name="col1-width" select="'0em'"/>
      <xsl:with-param name="col2-width" select="'15pt'"/>
      <xsl:with-param name="col3-width" select="''"/>
...
<xsl:template match="bullist//bullist/unlitem" priority="6">
  <table border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; " class=" x-unlitem-7-0 x--zero-left-margins">
    <xsl:call-template name="t-base-step-table">
      <xsl:with-param name="col1-width" select="'0em'"/>
      <xsl:with-param name="col2-width" select="'15pt'"/>
      <xsl:with-param name="col3-width" select="''"/>
...
<xsl:template match="enumlist/unlitem" priority="5">
  <table border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed; " class=" x-unlitem-8-0 x--zero-left-margins">
    <xsl:call-template name="t-base-step-table">
      <xsl:with-param name="col1-width" select="'1.5em'"/>
      <xsl:with-param name="col2-width" select="'12pt'"/>
      <xsl:with-param name="col3-width" select="''"/>
