...
<xsl:template match="_gte:deferredCrossReference2_save" mode="expand-gentext" priority="5">
  ...
  <xsl:variable name="style" select="@xrefStyle"/>
  <xsl:choose>
     <!--
     <xsl:when test="$style='Label_Number'">
        <xsl:apply-templates select="$child-title-node" mode="styler_xref-Label_Number"/>
     </xsl:when>
     <xsl:when test="$style='Label_Number_Text'">
        <xsl:apply-templates select="$child-title-node" mode="styler_xref-Label_Number_Text"/>
     </xsl:when>
     <xsl:when test="$style='Label_Number_Text_Page'">
     ...
     <!--
     <xsl:when test="$style='Number_Text'">
