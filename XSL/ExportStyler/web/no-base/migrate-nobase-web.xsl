...
<!--Copyright Arbortext, Inc., 1999-2008--><?APT StylesheetID Title="Migrate Stylesheet (XSL-Web)" CompositionTypes="htmlhelp,web,xsl"?><xsl:stylesheet xmlns:simg="java:net.sf.docbook.saxon.ImageIntrinsics"
                ...
                version="1.0"
                exclude-result-prefixes="_ xml _2 _5 saxon _4 _js xsi ch atidlm #default exslt msxsl _dtd _ufe _sfe _gte simg ximg _acl">
   ...
   <xsl:param name="relative-external-css-base-filename"
              select="'css/oh_pt6a_pt6a38_3021443_PROC'"/>
