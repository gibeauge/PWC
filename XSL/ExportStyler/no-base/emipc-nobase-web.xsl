...
<!--Copyright Arbortext, Inc., 1999-2008--><?APT StylesheetID Title="EMIPC Stylesheet (XSL-Web)" CompositionTypes="htmlhelp,web,xsl"?><xsl:stylesheet xmlns:simg="java:net.sf.docbook.saxon.ImageIntrinsics"
                ...
                version="1.0"
                exclude-result-prefixes="_ xml _2 _3 saxon _5 _js xsi ch atidlm #default exslt msxsl _dtd _ufe _sfe _gte simg ximg _acl">
...
<xsl:template name="__style-for_pwc-title.1">
      <xsl:text> .x-pwc-title-1-0 {margin-left: 0pt; margin-right: 0pt; text-indent: 0pt; font-size: 18pt; text-align: center; }</xsl:text>
   </xsl:template>
...
<xsl:template match="pwc-title" mode="styler_numbering" priority="0"><!--This context has no numbering--><xsl:param name="do-qmark" select="'yes'"/>
...
<xsl:template name="__style-for_pwcspbnbr.1">
      <xsl:text> .x-pwcspbnbr-1-0 {margin-left: 0pt; margin-right: 0pt; text-indent: 0pt; color: #0000FF; text-decoration: underline ; text-decoration: underline ; } /* source edit to add linking */</xsl:text>
   </xsl:template>
...
<xsl:template name="__style-for_sbnbr.2sbrbr52">
      <xsl:text> .x-sbnbr-2-0 {margin-left: 0pt; margin-right: 0pt; color: #0000FF; text-decoration: underline ; text-decoration: underline ; }</xsl:text>
   </xsl:template>

   <!--Template for Context: sbnbr-->
<xsl:template match="sbnbr" priority="0">
      <span><!--Emit class values to reflect conditions--><xsl:attribute name="class">
            <xsl:text> x-sbnbr-2-0</xsl:text>
         </xsl:attribute>
         <xsl:if test="@xml:lang">
            <xsl:attribute name="lang">
               <xsl:call-template name="return-lang-applying-language-map">
...
&#xD;
 .x-pwc-title-1-0 {margin-left: 0pt; margin-right: 0pt; text-indent: 0pt; font-size: 18pt; text-align: center; }
&#xD;
...
&#xD;
 .x-pwcspbnbr-1-0 {margin-left: 0pt; margin-right: 0pt; text-indent: 0pt; color: #0000FF; text-decoration: underline ; text-decoration: underline ; } /* source edit to add linking */
&#xD;
...
&#xD;
 .x-sbnbr-2-0 {margin-left: 0pt; margin-right: 0pt; color: #0000FF; text-decoration: underline ; text-decoration: underline ; }
&#xD;
