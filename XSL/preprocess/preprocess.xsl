...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
          ...
          <xsl:if test="name() = 'ata-page-block' or name() = 'page-block'">
            <xsl:choose>
              <xsl:when test="$document-type='epc' and descendant::*[name() = 'graphic'][title]">
                <xsl:element name="lof">
                  <xsl:element name="title">List of Figures</xsl:element>
            ...
            <xsl:if test="$document-type!='cir' and descendant::*[name() = 'table'][title]">
              <xsl:element name="lot">
                <xsl:element name="title">List of Tables</xsl:element>
    ...
    <table tabstyle="Highlights" role="{@applic}" frame="all">
      <tgroup cols="{$cols}" >
        <xsl:choose>
          ...
          <thead>
            <row>
              <entry colsep="0" rowsep="1">T.R. No.</entry>
              <xsl:if test="$cols = '4'">
                <entry colsep="0" rowsep="1">Effectivity</entry>
              </xsl:if>
              <entry colsep="0" rowsep="1">Filed Adjacent to</entry>
              <entry colsep="0" rowsep="1">T.R. Status</entry>
            </row>
  ...
  <xsl:template name="highlights">
    <highlights id="{concat($book-pnbr, 'highlights')}">
      <title id="{concat($book-pnbr, 'highlights.title')}">HIGHLIGHTS</title>
      <table tabstyle="Highlights" role="{@applic}" frame="none">
        ...
        <tgroup cols="4" >
          ...
          <thead>
            <row>
                                                        <!-- gdb 11-27-12 JIRA_811 added: Revision column -->
              <entry colsep="0" rowsep="1">Revision</entry>
                                                        <entry colsep="0" rowsep="1">CH/SE/SU</entry>
              <entry colsep="0" rowsep="1">Pageblock Title</entry>
              <entry colsep="0" rowsep="1">Description of Change</entry>
            </row>
          ...
          <thead>
            <row>
              <entry colsep="0" rowsep="0">
                ...
                <xsl:text>CHAPTER/SECTION/SUBJECT</xsl:text>
  ...
  <xsl:template match="parts-list">
      ...
      <tgroup cols="7" >
        ...
        <thead>
          <row>
            ...
            <entry colsep="0" rowsep="1">Fig. Item</entry>
            <entry colsep="0" rowsep="1">Part No.</entry>
            <entry colsep="0" rowsep="1">Airline Part No.</entry>
            <entry colsep="0" rowsep="1">Nomenclature</entry>
            <entry colsep="0" rowsep="1">Effect Code</entry>
            <entry colsep="0" rowsep="1">Units Per Assy.</entry>
          </row>
                ...
                <xsl:when test="preceding-sibling::*[name() = 'revst'][1]/count(preceding-sibling::*[name() = 'revst']) =
                  ...
                  <row role="changebar" changebar="yes">
                    <entry>
                      <fignote>
                        <xsl:copy-of select="@*"/>
                        <emphasis>Note <xsl:value-of select="@fignote-nbr"/>:</emphasis>
                      </fignote>
                    </entry>
                    <entry >
                      <xsl:value-of select="."/>
    ...
    <para><emphasis role="bold"><dash/></emphasis> ITEM NOT ILLUSTRATED</para>
    ...
    <table tabstyle="eff-code" frame="none" id="eff-code-table">
      <tgroup cols="2" >
        ...
        <thead>
          <row rowsep="1">
            <entry colsep="0" rowsep="1">EFF</entry>
            <entry colsep="0" rowsep="1">MODEL</entry>
          </row>
        </thead>
        <tbody>
  ...
  <xsl:template name="partial-bd-row">
    <row rowsep="0">
      ...
      <entry rowsep="0"></entry>
      <entry rowsep="0"></entry>
      <entry rowsep="0">PARTIAL BREAKDOWN FOLLOWS:</entry>
      <entry rowsep="0"></entry>
      <entry rowsep="0"></entry>
    </row>
  </xsl:template>
  ...
  <xsl:template name="attach-parts-row">
    <row rowsep="0">
      ...
      <entry rowsep="0"></entry>
      <entry rowsep="0">
        <emphasis role="bold">ATTACHING PARTS</emphasis>
        <xsl:processing-instruction name="Pub">_newline</xsl:processing-instruction>
      </entry>
      <entry rowsep="0"></entry>
      <entry rowsep="0"></entry>
  ...
  <xsl:template name="kits-row">
    <row rowsep="0">
      ...
      <entry rowsep="0"></entry>
      <entry rowsep="0"></entry>
      <entry rowsep="0">KITS, REPAIR/SERVICE PARTS</entry>
      <entry rowsep="0"></entry>
      <entry rowsep="0"></entry>
    </row>
  </xsl:template>
                  ...
                  <row rowsep="1">
                    ...
                    <entry>
                      <xsl:if test="parent::item[@attach = '1'] 
                        ...
                        <emphasis role="bold"><xsl:text>ATTACHING PARTS</xsl:text></emphasis>
                        <xsl:processing-instruction name="Pub">_newline</xsl:processing-instruction>
                      </xsl:if>
                      <itemspec>
    ...
    <xsl:copy>
      ...
      <table>
        <tgroup cols="3" >
          ...
          <thead>
            <row>
              <entry>P&amp;WC SPB No.</entry>
              <entry>Rev. No.</entry>
              <entry>Incorporation Status</entry>
            </row>
          </thead>
          <tbody>
